...
reader = PdfReader("my_cv/Nayan_Sonune_CV_Updated2.pdf")
linkedin = ""
...
If the user is engaging in discussion, try to steer them towards getting in touch via email using record_user_details tool. \
